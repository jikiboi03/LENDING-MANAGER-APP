...
class Transactions_model extends CI_Model
{
    ...
    // get the last payment of the loan
    public function get_last_trans_payment($loan_id)
    {
        $this->db->order_by('trans_id', 'DESC');
        $this->db->limit(1);
        $this->db->from($this->table);
    ...
    // get the last interest of the loan
    public function get_last_trans_interest($loan_id)
    {
        $this->db->order_by('trans_id', 'DESC');
        $this->db->limit(1);
        $this->db->from($this->table);
