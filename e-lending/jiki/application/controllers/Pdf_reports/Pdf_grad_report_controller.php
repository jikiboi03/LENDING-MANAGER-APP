...
class Pdf_grad_report_controller extends CI_Controller {
	...
	public function index($gender)
	{
		...
		$data['title'] = 'CIS Graduated Children Records - ' . $gender;
		...
		// column titles
		$data['header'] = array('ID', 'Fullname', 'Age', 'I.Height', 'Stats', 'I.Weight', 'Stats', 'Barangay');

		$this->load->library('MYPDF');
		$this->load->view('reports/makepdf_grad_view', $data);
	}

	// Load table data from file
	public function LoadData($gender) {

		$list = $this->cis->get_children_graduated_list();
		$data = array();
