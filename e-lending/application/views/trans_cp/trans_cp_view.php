                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><b><?php echo 'L' . $loan->loan_id ?></b><span style="float:right;"><button type="button" style="width: 100%;" class="btn btn-dark"  onclick="cancel_cp_trans()"><i class="fa fa-sign-out"></i> &nbsp;Back to Portal</button></span></h3>
                        </div>
